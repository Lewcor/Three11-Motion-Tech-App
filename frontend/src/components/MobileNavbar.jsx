...
import { Sparkles, Crown, Zap, Brain, Menu, X, Mic, TrendingUp, Shuffle, Target, Calendar, BookOpen, BarChart3, Video, Headphones, Mail, PenTool, Package, TestTube, Telescope, Eye, Users2, UserCog, MessageSquareMore, Share2, Send, Database, Workflow, HelpCircle, Monitor } from 'lucide-react';
                ...
                <div className="border-t pt-4">
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="w-full h-10 px-4 py-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-md text-sm font-medium transition-colors inline-flex items-center justify-center"
                    >
                      Logout
                    </button>
                  </div>
