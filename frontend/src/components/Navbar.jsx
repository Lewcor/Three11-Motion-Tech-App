              ...
              return (
                <div key={category.id} className="relative">
                  ...
                  >
                    ...
                    {category.name}
                    <Badge className={`ml-1 ${category.badgeColor} text-white text-xs`}>
                      {category.badge}
                    </Badge>
                  ...
                  {openDropdown === category.id && (
                    <div className="absolute top-full left-0 mt-1 w-64 bg-white/95 backdrop-blur-md border border-slate-200 rounded-lg shadow-lg z-50">
                      <div className="p-2">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-md border-t border-slate-200">
          <div className="px-4 py-4 space-y-2">
            {navCategories.map((category) => (
              <div key={category.id}>
                <div className="text-sm font-semibold text-slate-700 px-2 py-1">
                  {category.name}
                </div>
                  ...
                  {category.items.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        className="flex items-center px-3 py-2 rounded-md text-sm hover:bg-slate-100"
                      >
                        <ItemIcon className="h-4 w-4 mr-3" />
                        {item.name}
