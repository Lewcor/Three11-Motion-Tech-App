        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              Powered by Group 1 (Creative & Engaging), Group 2 (Thoughtful & Nuanced), and Group 3 (Trendy & Current) working together.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              ...
              <Link to="/voice-studio">
                <Button size="lg" className="group relative overflow-hidden bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700">
                  <span className="relative z-10 flex items-center">
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 dark:text-slate-300">
                  First-ever platform combining Group 1, 2, and 3 for unmatched creativity
                </p>
                <div className="mt-4 flex justify-center gap-2">
                  <Badge variant="outline" className="text-xs">Group 1</Badge>
                  <Badge variant="outline" className="text-xs">Group 2</Badge>
                  <Badge variant="outline" className="text-xs">Group 3</Badge>
                </div>
              </CardContent>
            </Card>
